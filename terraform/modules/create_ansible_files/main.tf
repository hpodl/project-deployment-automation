...
[bastion]
${var.bastion_ip} ansible_ssh_private_key_file=${var.bastion_key}
...
resource "local_file" "tf_known_hosts_file" {
  filename = "${var.ansible_dir}/known_hosts.txt"
  content  = <<EOF
# Generated by Terraform
# Hosts created by Terraform and their public keys

${var.bastion_ip} ${var.bastion_pubkey}
${local.hosts_file_content}
EOF
}
